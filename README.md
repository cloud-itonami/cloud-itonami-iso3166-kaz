# cloud-itonami-iso3166-kaz

Open ISO 3166 Blueprint for **KAZ**: Kazakhstan.
...
tax registration, and local-content rules in Kazakhstan, so the operator
...
- **Not the government of Kazakhstan.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Kazakhstani-licensed counsel
...
(ISO 3166 `KAZ`). Required capabilities:
