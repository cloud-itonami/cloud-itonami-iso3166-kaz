# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Kazakhstan

## Classification

- Repository: `cloud-itonami-iso3166-kaz`
- ISO 3166: `KAZ` (Kazakhstan)
...
- Social impact: [:kazakhstani-sme-market-access :public-spend-transparency :cross-border-friction-reduction]

## Customer

- an already-incorporated `cloud-itonami-cofog-{code}` /
  `cloud-itonami-isco-{code}` / `cloud-itonami-unspsc-{segment}` /
  `cloud-itonami-{ISIC}` operator wanting to bid on a Kazakhstani
  public contract
...
- registration walkthrough for Goszakup (goszakup.gov.kz), Kazakhstan's
  centralized electronic public-procurement portal operated by the
  Ministry of Finance, covering notice publication, electronic bid
  submission, evaluation and contract award
- business/tax registration checklist: a Business Identification Number
  (BIN) via the State Revenue Committee and an Electronic Digital
  Signature (EDS) from the National Certification Centre, obtained
  through registration on eGov.kz
- local-content / preferential-procurement navigation: Kazakhstan's
  public-procurement rules' domestic-preference provisions favoring
  locally manufactured goods on qualifying tenders
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Kazakhstani-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in Kazakhstan).
