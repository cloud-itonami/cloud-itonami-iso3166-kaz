(ns marketentry.store
  "SSoT for the KAZ market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems KZ" :portal "goszakup.gov.kz"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kz-entity? true :has-kz-entity? true
             :requires-bin? true :bin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KAZ" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "goszakup.gov.kz"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kz-entity? true :has-kz-entity? true
             :requires-bin? true :bin-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "goszakup.gov.kz"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "KAZ" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "goszakup.gov.kz"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kz-entity? true :has-kz-entity? false
             :requires-bin? true :bin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KAZ" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "goszakup.gov.kz"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kz-entity? true :has-kz-entity? true
             :requires-bin? true :bin-verified? false
             :drafted? false :submitted? false
             :jurisdiction "KAZ" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "goszakup.gov.kz"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-kz-entity? has-kz-entity?
                               requires-bin? bin-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-kz-entity?)  (assoc :engagement/requires-kz-entity? requires-kz-entity?)
    (some? has-kz-entity?)       (assoc :engagement/has-kz-entity? has-kz-entity?)
    (some? requires-bin?)    (assoc :engagement/requires-bin? requires-bin?)
    (some? bin-verified?)    (assoc :engagement/bin-verified? bin-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-kz-entity? :engagement/has-kz-entity?
   :engagement/requires-bin? :engagement/bin-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-kz-entity? (boolean (:engagement/requires-kz-entity? m))
     :has-kz-entity? (boolean (:engagement/has-kz-entity? m))
     :requires-bin? (boolean (:engagement/requires-bin? m))
     :bin-verified? (boolean (:engagement/bin-verified? m))
